export const de = {
  ...
  // Pedigree Analysis
  tool_pedigree_reg_title: 'Stammbaumanalyse',
  tool_pedigree_reg_desc: 'Erstelle einen Familienstammbaum und leite daraus das wahrscheinliche Mendel\'sche Vererbungsmuster ab (autosomal/X-gebunden, dominant/rezessiv).',
  tool_pedigree_add_person: 'Person hinzufügen',
  tool_pedigree_male: 'Männlich',
  tool_pedigree_female: 'Weiblich',
  tool_pedigree_generation: 'Generation',
  tool_pedigree_father: 'Vater (optional)',
  tool_pedigree_mother: 'Mutter (optional)',
  tool_pedigree_affected: 'Betroffen',
  tool_pedigree_add: 'Zum Stammbaum hinzufügen',
  tool_pedigree_load_example: 'Beispielstammbaum laden',
  tool_pedigree_chart_title: 'Stammbaum',
  tool_pedigree_no_individuals: 'Noch keine Personen - füge oben eine hinzu oder lade das Beispiel.',
  tool_pedigree_inference_title: 'Vererbungsmuster-Analyse',
  tool_pedigree_most_likely: 'Am ehesten vereinbar mit',
  tool_pedigree_ruled_out: 'Ausgeschlossen',
  tool_pedigree_pattern_ad: 'Autosomal-dominant',
  tool_pedigree_pattern_ar: 'Autosomal-rezessiv',
  tool_pedigree_pattern_xd: 'X-chromosomal-dominant',
  tool_pedigree_pattern_xr: 'X-chromosomal-rezessiv',
  tool_pedigree_error_id_required: 'Bitte gib eine ID für diese Person ein.',
  tool_pedigree_error_duplicate_id: 'Diese ID wird bereits verwendet - wähle eine eindeutige.',
  tool_pedigree_error_bad_generation: 'Die Generation muss eine Zahl größer oder gleich 1 sein.',

  // qPCR Efficiency Calculator
  tool_qpcr_reg_title: 'qPCR-Effizienzrechner',
  tool_qpcr_reg_desc: 'Berechnet die Real-Time-PCR-Amplifikationseffizienz aus einer Verdünnungsreihen-Standardkurve (Ct vs. log Verdünnung).',
  tool_qpcr_standard_curve_data: 'Standardkurven-Daten',
  tool_qpcr_load_sample: 'Beispieldaten laden',
  tool_qpcr_dilution: 'Relative Menge (höher = mehr Template)',
  tool_qpcr_ct: 'Ct-Wert',
  tool_qpcr_add_row: 'Zeile hinzufügen',
  tool_qpcr_efficiency: 'Amplifikationseffizienz',
  tool_qpcr_slope: 'Steigung',
  tool_qpcr_intercept: 'Achsenabschnitt',
  tool_qpcr_verdict_ideal: 'Ideal (90-110%)',
  tool_qpcr_verdict_acceptable: 'Akzeptabel',
  tool_qpcr_verdict_poor: 'Schwach',

  // qPCR CSV upload
  tool_qpcr_upload_csv: 'CSV hochladen',
  tool_qpcr_csv_parse_error: 'In dieser Datei wurden nicht mindestens 2 gültige Zahlenzeilen gefunden. Erwartetes Format: 1000,18.2',
};
